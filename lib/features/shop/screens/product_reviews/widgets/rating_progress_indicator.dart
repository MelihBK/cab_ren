import 'package:cab_ren/features/shop/screens/product_reviews/widgets/progress_indicator_and_rating.dart';
...
class TOverallProductRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(flex: 3, child: Text('4.8', style: Theme.of(context).textTheme.bodyLarge)),
        const Expanded(
          flex: 7,
          child: Column(
            children: [
